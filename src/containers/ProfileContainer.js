  ...
  render() {
    return (
      <div>
        ...
        {this.props.pairsToggle ? <PairingList foodwines={this.props.foodwines} foods={this.props.foods} wines={this.props.wines} reviews={this.props.reviews} updateReview={this.props.updateReview} /> : null}
      </div>
    )
  }
}
